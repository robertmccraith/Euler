...
def lr(mat):
    ...
    for i in range(0,mat.shape[0]):
        for j in range(0,mat.shape[1]):
            gp = max(gp, reduce(lambda a,b: a*b, mat[i, j:j+4], 1))
...
def diag(mat):
    ...
    for i in range(0,mat.shape[0]-3):
        for j in range(0,mat.shape[1]-3):
            print(np.diagonal(mat[i:i+4, j:j+4]))
            gp = max(gp, reduce(lambda a,b: a*b, np.diagonal(mat[i:i+4, j:j+4]), 1))
